...
reynolds_frame <- read.table(file="locus_D8S1179.mat",fill=TRUE,header=TRUE)
...
# run the MDS
D8S1179_MDS <- metaMDS(reynolds_dist)

# open PNG device to output graphic in PNG format
png(file="D8S1179_MDS_plot.png")

# create the plot
plot(D8S1179_MDS,type="n",xlab="Axis 1", ylab="Axis 2", main="D8S1179 across Gibraltar")

# add the points
points(D8S1179_MDS,pch=19,col=region_colors)
