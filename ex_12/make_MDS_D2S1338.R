...
reynolds_frame <- read.table(file="locus_D2S1338.mat",fill=TRUE,header=TRUE)
...
# run the MDS
D2S1338_MDS <- metaMDS(reynolds_dist)

# open PNG device to output graphic in PNG format
png(file="D2S1338_MDS_plot.png")

# create the plot
plot(D2S1338_MDS,type="n",xlab="Axis 1", ylab="Axis 2", main="D2S1338 across Gibraltar")

# add the points
points(D2S1338_MDS,pch=19,col=region_colors)
